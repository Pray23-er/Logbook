...
@vite('resources/css/app.css')
    <div class="container mx-auto p-4 pt-6 mt-10">
        <h1 class="text-4xl font-bold mb-4 text-indigo-900">Add Student to Your Company</h1>

        <a href="{{ route('forms.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mb-4 shadow-md">Add Student</a>
