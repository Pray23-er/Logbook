                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105 border border-gray-200 dark:border-gray-700">
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-6">Access the student dashboard for logbook entry, submission and approvals.</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105 border border-gray-200 dark:border-gray-700">
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-6">Access school dashboard for effective and real time monitoring of your  students.</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105 border border-gray-200 dark:border-gray-700">
                    <div class="p-6">
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-6">Engage actively by accessing the  company dashboard for logbook approvals.</p>
                        </div>
