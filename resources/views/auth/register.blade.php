<x-layout>
    ...
    <div class="mt-4 max-w-6xl max-auto ml-20">
...
<div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg" >
    ...
    <form method="POST" action="{{route('register.store')}}">
        ...
        <div class="mb-5">
            ...
            <input type="text" id="base-input" class="@error('name')
                 border-red-500
             @enderror
             bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="name">
            @error('name')
