...
<div class="container mx-auto p-4 pt-6">
    <h1 class="text-4xl font-bold mb-4 text-indigo-900 dark:text-indigo-400 text-center"><i class="bi bi-people me-2"></i> Student List</h1>
            ...
            <table class="table table-borderless table-hover table-striped w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 align-middle">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-lg font-medium text-center"><i class="bi bi-gear me-2"></i> Action</th>
                    </tr>
                </thead>
                <tbody>
