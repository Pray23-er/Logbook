...
@endif
    ...
    <div class="flex flex-row justify-between mb-4">
        <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative" style="width: 20rem;">
        ...
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" style="width: 20rem;">
    ...
    <div class="flex flex-row justify-between mb-4">
        <div class="bg-gray-100 border border-gray-400 text-gray-700 px-4 py-3 rounded relative" style="width: 20rem;">
            ...
            <ul>
                <li class="mb-2"><a href="{{ route('company.view.student') }}" class="text-blue-600 hover:text-blue-800">View Student List</a></li>
                <li class="mb-2"><a href="{{ route('forms.index') }}" class="text-blue-600 hover:text-blue-800">Create New Account</a></li>
                <li class="mb-2"><a href="{{ route('company.password.edit') }}" class="text-blue-600 hover:text-blue-800">Update Password</a></li>
            </ul>
        </div>
